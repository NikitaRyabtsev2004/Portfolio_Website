...
import HeroBgAnimation from "../HeroBgAnimation/HeroBgAnimationStyle";
...
const Img = styled.img`
  ...
  max-width: 400px;
  max-height: 400px;
  border: 10px double ${({ theme }) => theme.primary};
          ...
          <HeroInnerContainer>
            <HeroLeftContainer>
              <motion.div {...headTextAnimation}>
                <Title>
                  {App_Text.hi} <br /> {App_Text.my_name}
                </Title>
                <TextLoop>
                  {App_Text.i_am}
                  <Span>
